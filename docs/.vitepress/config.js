import { vueFragment, miniProgram, gitOrder, mindMap, jsFragment, editorUtility, environment, OpenLayers } from "./menu1Sidebar";
...
export default {
  ...
  themeConfig: {
      ...
      nav: [
          ...
          { text: 'OpenLayers', link: '/OpenLayers/OpenLayers基本使用.html', activeMatch: '/OpenLayers/' },
